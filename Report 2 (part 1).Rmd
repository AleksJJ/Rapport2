...
library(kableExtra)
library(knitr)
lactate_threshold <- read_excel("~/Documents/HINN/IDR4000/R/Rapport_2/Rapport2/lactate_threshold.xlsx", col_types = c("numeric", "text", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric"))
